...
func (b *Business) GenerateConfirmRegisterToken(newEmail string) (string, error) {
...
func (b *Business) isPosibleCreateNewSession(ctx context.Context, userID uuid.UUID) (uuid.UUID, error) {
...
func (b *Business) CreateOrgSelectSession(ctx context.Context, userID uuid.UUID, deviceInfo string) (string, error) {
	...
	newSession := CreateUserSessionStruct{
		UserID:     userID,
		SessionID:  sessionID,
...
func (b *Business) CreateMembershipSession(ctx context.Context, userID, membershipID, sessionID uuid.UUID) (string, error) {
...
func (b *Business) DeleteUserSession(ctx context.Context, tokenSession string) {
...
func (b *Business) CheckSessionIsActive(ctx context.Context, sessionID uuid.UUID) (bool, error) {
