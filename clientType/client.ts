// Code generated by the Encore v1.53.1 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-encoretruck-zpoi.encr.app`
}
...
/**
 * Client is an API client for the encoretruck-zpoi Encore application.
 */
export default class Client {
    public readonly appService: appService.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.appService = new appService.ServiceClient(base)
    }
...
export interface ClientOptions {
     ...
     */
    auth?: authhandler.Params | AuthDataGenerator
}

export namespace appService {
    export interface CreateOrgResponse {
        data: sharedapp.Membership
    }
    ...
    export interface reqCreateCompanyOrgRequest {
        companyName: string
    }

    export interface responseGetAllOrganizations {
    }
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.GetUserMemberships = this.GetUserMemberships.bind(this)
...
export namespace authhandler {
    export interface Params {
         ...
         */
        MembershipIdSelected: string
    }
}

export namespace sharedapp {
    export interface Membership {
        ...
        /**
         * Status of the membership (active, revoked, etc)
         */
        status: string

        /**
         * Creation time of the membership
         */
        "created_at": string

        /**
         * Finalization time of the membership
         */
        "finalized_at": string

        /**
         * Name of the organization where the membership belongs
         */
        "org_name": string
...
export type AuthDataGenerator = () =>
  | authhandler.Params
  | Promise<authhandler.Params | undefined>
  | undefined;
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "encoretruck-zpoi-Generated-TS-Client (Encore/v1.53.1)";
        }
    ...
    async getAuthData(): Promise<CallParameters | undefined> {
        let authData: authhandler.Params | undefined;
        ...
        if (authData) {
            ...
            data.headers = makeRecord<string, string>({
                ...
                "x-membership-id": authData.MembershipIdSelected,
            });
